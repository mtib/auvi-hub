...
\lstinputlisting[language=Python,firstline=12, lastline=40,caption={,,Mainfunktion'' von \vsr\ (auvi.py)}]{\pyvidir auvi.py}
\lstinputlisting[language=Python,caption={Wrapper für Abhandeln der Ortsdefinitionen}]{\pyvidir local.py}
...
\lstinputlisting[language=json, caption={Beispielobjekte für Ortspunkte}]{\pyvidir locals.json}
...
\lstinputlisting[language=C]{\pyvidir grads/line.gs}
\lstinputlisting[language=C]{\pyvidir grads/plot.gs}
