...
\begin{document}
\pagestyle{empty}
\title{\includegraphics[scale=.34]{imgs/auvi_white.png}\\Personalisierte Datenverarbeitung\\und Visualisierung von Wetterprognosedaten}
