...
Die Abstrahierung in Position, Zoom und Zeitzone ist Industriestandart. Die Position wird in
...
Stelle das Byte 0x10 für den New Line Charakter steht, denn um eine valide JSON Datei zu erhalten,
...
caption={GrADS Routine zum erstellen
allgemeiner Funktionsgraphen (line.gs)}]{\pyvidir grads/line.gs}
\lstinputlisting[language=grads,
...
Um den Ablauf des Programmes zu verstehen sind
...
Oberfläche, ist die Herleitung der Grafikuris so realisiert, dass durch das PHP
...
dar, weil die PHP Oberfläche etwas über den Hintergrund des Algorithmuses wissen muss.
...
bei solch einer einfachen Aufgabe ein starter Performanceeinbruch.\\
...
ist endlich auf der Platform travis-ci.org realisiert.
...
Als Editor wurde zuerst SublimeText genutzt
um die Bash- und später Pythondateien zu bearbeiten.
SublimeText wurde zwischenzeitlich durch Eclipse
...
Listing Paket von \LaTeX geschrieben werden, da die GrADS Syntax keiner üblich genutzen
Syntax entspricht.\\
...
Im Jahr darauf trat das Projekt ,,Auvi'' alleine an. Auch wenn kein Podiumsplatz
